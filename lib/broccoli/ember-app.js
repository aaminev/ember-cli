...
EmberApp.prototype._addonTree = function _addonTree() {
  ...
  var templatesGlobs = ['**/templates/**/*', '**/template.js'];

  var addonTemplatesTree = new ES6Modules(
    new Funnel(addonTrees, {
      include: templatesGlobs,
      annotation: 'Funnel: Addon Templates'
    }),
    {
      description: 'ES6: Addon Templates Tree',
      esperantoOptions: {
        absolutePaths: true,
        strict: true,
  ...
  addonTrees = new Funnel(addonTrees, {
    exclude: templatesGlobs
  });
...
EmberApp.prototype.appAndDependencies = function() {
  ...
  var app;
  var templates = new ES6Modules(this._processedTemplatesTree(), {
    description: 'ES6: App Templates Tree',
    esperantoOptions: {
      absolutePaths: true,
      strict: true,
      _evilES3SafeReExports: this.options.es3Safe
